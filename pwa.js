...
const cacheName = 'FixitLevelUp3MitchellLeon-2020-11-21 18:09:27.160330'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FixitLevelUp3MitchellLeon'.length) === 'FixitLevelUp3MitchellLeon') {
